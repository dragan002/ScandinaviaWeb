                ...
                <div class="form__group form__group--hidden">
                    <div class="form__group form__group--hidden-item pt-2 pb-2 pl-1 pr-1 xs-p-2 md-p-3 lg-pt-5 lg-pb-5" id="Book">
                        <div class="form__item grid sm-pb-2 pb-2">
                            ...
                            <input type="number" id="weight" name="weight" class="form__input col-start-2 lg-col-span-9 c-input" step="0.01" value="<?= htmlspecialchars($_POST['weight'] ?? '') ?>">
                        </div>
                    ...
                    <div class="form__group form__group--hidden-item pt-1 pb-1 pt-2 pb-2 pl-1 pr-1 xs-p-2 md-p-3 lg-pt-5 lg-pb-5" id="DVD">
                        <div class="form__item grid sm-pb-2 pb-2">
                            ...
                            <input type="number" id="size" name="size" class="form__input col-start-2 c-input" value="<?= htmlspecialchars($_POST['size'] ?? '') ?>">
                        </div>
                    ...
                    <div class="form__group form__group--hidden-item grid pt-2 pb-2 pl-1 pr-1 xs-p-2 md-p-3 lg-pt-5 lg-pb-5" id="Furniture">
                        <div class="form__item col-start-1 grid sm-pb-2">
                            ...
                            <input type="number" id="height" name="height" class="form__input col-start-2 c-input" step="0.01" value="<?= htmlspecialchars($_POST['height'] ?? '') ?>">
                        </div>
                        <div class="form__item col-start-1 grid sm-pb-2">
                            <label for="width" class="form__label col-start-1 pr-1">Width (CM)</label>
                            <input type="number" id="width" name="width" class="form__input col-start-2 c-input" step="0.01" value="<?= htmlspecialchars($_POST['width'] ?? '') ?>">
                        </div>
                        <div class="form__item col-start-1 grid sm-pb-2">
                            <label for="length" class="form__label col-start-1">Length (CM)</label>
                            <input type="number" id="length" name="length" class="form__input col-start-2 c-input" step="0.01" value="<?= htmlspecialchars($_POST['length'] ?? '') ?>">
                        </div>
