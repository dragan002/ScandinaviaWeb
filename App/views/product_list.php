...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (count($deletingList) > 0) {
        // Start building the notification message and list
...
<body>
    ...
    <?php echo $notification; ?>
        <form class="product-list__form mt-10 mb-10 grid" id="product-list" method="POST" action="../index.php">
            ...
            <button type="submit" class="product-list__button product-list__button-delete c-button--primary p-small col-span-3 sm-col-span-2 lg-col-span-2">MASS DELETE</button>
